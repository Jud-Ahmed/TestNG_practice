...
public class TitleAndLogoValidation extends CommonMethods{
	...
	/* commenting them out since we made the setUp() and tearDown() as BeforeMethod and AfterMethod
	...
	*/
	...
	{
		String expectedTitle = "OrangeHR"; //intentionally failing this test (it should be OrangeHRM)
